...
Track Release date vs Danceability, energy, liveliness, loudness 
Tempo vs liveliness 
...
Using one of the Shiny templates, I will customize it to make the various graphs interactive.I will also include some ggplots.  
...
# create matrix 
data= matrix(c('ggplot',2,'shiny',8), ncol=2, byrow=TRUE)
