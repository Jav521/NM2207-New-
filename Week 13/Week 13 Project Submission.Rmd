...
One important concept that really helped my workflow was the "if/else" statement. It was very important for setting up conditions for my interface. I also learnt how to include radio buttons in my interface, and how to create a reactive interface. It was challenging at the start, but it got fun once I began to get the hang of it. 
