...
```{r, eval=T,echo=TRUE}
# Enter code here
slice(select(hotels,lead_time),1:10)
...
```{r, eval=T,echo=TRUE}
# Enter code here
slice(select(hotels,lead_time,market_segment),1:10)
...
```{r, eval=T,echo=TRUE}
# Enter code here
slice(arrange(hotels,lead_time),1:10)
```
...
```{r, eval=T,echo=TRUE}
# Enter code here
slice(arrange(hotels,desc(lead_time)),1:10)
```
...
slice(arrange(select(hotels,lead_time),desc(lead_time)),1:10)
